...
export default function ErrorPage({
  ...
  return (
    <div className="min-h-screen bg-background-dark text-white font-sans relative overflow-hidden">
      ...
      {/* Floating particles */}
      <div className="fixed left-[15%] top-[25%] w-2 h-2 bg-[#7C4DFF] rounded-full blur-[2px] opacity-40 animate-pulse pointer-events-none" />
      ...
      <div className="fixed left-[60%] bottom-[20%] w-2.5 h-2.5 bg-[#7C4DFF] rounded-full blur-[2px] opacity-30 animate-pulse pointer-events-none" />
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 pt-28 pb-12">
        <div className="w-full max-w-md">
          ...
          >
            {/* Glow behind card */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#7C4DFF]/20 to-[#7C4DFF]/5 rounded-3xl blur-3xl scale-105" />
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 40px rgba(124,77,255,0.1), 0 8px 32px rgba(0,0,0,0.4)',
              }}
            >
              {/* Icon */}
              <motion.div
              ...
              >
                <WarningOutlined className="text-3xl text-[#7C4DFF]" />
              </motion.div>
              ...
              <motion.p
                ...
                className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#7C4DFF]/70 mb-3"
              >
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-8">
                Đã xảy ra lỗi không mong muốn phía máy chủ.
                <br />
                Vui lòng thử lại sau hoặc liên hệ hỗ trợ.
              </p>

              {/* Error digest (dev only hint) */}
              {process.env.NODE_ENV === 'development' && error?.digest && (
                <p className="text-[10px] text-red-400/50 font-mono mb-6 break-all">
                  ID: {error.digest}
                </p>
              )}
